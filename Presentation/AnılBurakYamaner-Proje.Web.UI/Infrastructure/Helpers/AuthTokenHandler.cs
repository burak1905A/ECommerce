...
namespace AnılBurakYamaner_Proje.Web.UI.Infrastructure.Helpers
{
    public class AuthTokenHandler : DelegatingHandler
    {
        ...
        {
            if (_httpContextAccessor.HttpContext.Request.Cookies.ContainsKey("AnılBurakYamaner-ProjeAccessToken"))
            {
                var cookieStr = _httpContextAccessor.HttpContext.Request.Cookies["AnılBurakYamaner-ProjeAccessToken"].Decrypt();
                ...
                if (cookieModel.AcceessToken.Expires <= DateTime.Now.ToUnixTime())
                {
                    ...
                    if (getAccessTokenResult.IsSuccessStatusCode && getAccessTokenResult.Content.IsSuccess)
                    {
                        ...
                        _httpContextAccessor.HttpContext.Response.Cookies.Append("AnılBurakYamaner-ProjeAccessToken", 
