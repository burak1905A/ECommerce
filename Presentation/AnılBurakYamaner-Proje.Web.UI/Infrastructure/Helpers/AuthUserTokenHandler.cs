...
{
    public class AuthUserTokenHandler : DelegatingHandler
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IAccountApi _accountApi;

        public AuthUserTokenHandler(
        ...
        {
            if (_httpContextAccessor.HttpContext.Request.Cookies.ContainsKey("AnılBurakYamaner-UserProjeAccessToken"))
            {
                var cookieStr = _httpContextAccessor.HttpContext.Request.Cookies["AnılBurakYamaner-UserProjeAccessToken"].Decrypt();
                ...
                if (cookieModel.AcceessToken.Expires <= DateTime.Now.ToUnixTime())
                {
                    ...
                    if (getAccessTokenResult.IsSuccessStatusCode && getAccessTokenResult.Content.IsSuccess)
                    {
                        ...
                        _httpContextAccessor.HttpContext.Response.Cookies.Append("AnılBurakYamaner-UserProjeAccessToken", 
