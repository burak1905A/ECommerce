...
using AnılBurakYamaner_Proje.Web.UI.Areas.User.Models.OrderItemViewModels;
using AnılBurakYamaner_Proje.Web.UI.Areas.User.Models.ProductCommentViewModels;
using AnılBurakYamaner_Proje.Web.UI.Areas.User.Models.ProductDetailViewModels;
using AnılBurakYamaner_Proje.Web.UI.Areas.User.Models.ProductImageViewModels;
...
namespace AnılBurakYamaner_Proje.Web.UI.Areas.User.Models.ProductViewModels
{
